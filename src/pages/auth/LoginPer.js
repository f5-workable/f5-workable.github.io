...
const LoginPer = () => {
  return (<>
    <div className="absolute inset-0 z-0">
      <video className="w-full h-full object-cover" src="/videos/backgroundVideo.mp4" autoPlay loop muted></video>
    </div>
    <div className="relative my-16 z-10">
      <div className=" bg-white relative w-3/5 mx-auto shadow-2xl flex content-center" name="container">
        <div className="w-1/2 p-10">
          <div className="text-center text-3xl font-bold">로그인</div>
            ...
            <div className="flex justify-center">
              <button className=" bg-orange-200 hover:bg-orange-400 rounded-md py-2 px-5">로그인</button>
            </div>
        ...
        <div className='w-1/2 p-10'><img src="/images/loginMemberRight.PNG" alt="loginRight" loading="lazy" /></div>
      </div>
    </div>
  </>);
};
