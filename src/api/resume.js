...
const resume = {
  ...
  search: (
    ...
    request.get(
      `/resume/search?payment_type=${payment_type}&disease=${disease}&ob_type=${ob_type}&place=${place}&education=${education}&keyword=${keyword}&sort=${sort}&pageNum=${pageNum}&pageSize=${pageSize}`
    ),
