      ...
      <div className="w-full h-96 flex bg-white rounded-md overflow-hidden border border-solid border-neutral-400">
        <div className="w-1/4 h-full bg-white border-r border-solid border-neutral-400 overflow-y-scroll">
          <ul className="grid grid-cols-2">
            <Region value="전체" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="서울" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="부산" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="대구" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="인천" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="광주" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="대전" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="울산" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="세종" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="경기" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="강원" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="충북" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="충남" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="전북" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="전남" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="경북" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="경남" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
            <Region value="제주" selectedLocation={selectedLocation} onClick={handleSelectedLocation} />
          </ul>
        </div>
